...
BEGIN
  ...
  LOOP
    ...
    UPDATE public.cv_uploads SET org_id = new_org_id WHERE user_id = user_record.id;
    UPDATE public.candidate_notes SET org_id = new_org_id WHERE user_id = user_record.id;
    UPDATE public.batch_uploads SET org_id = new_org_id WHERE user_id = user_record.id;
    UPDATE public.saved_searches SET org_id = new_org_id WHERE user_id = user_record.id;
    UPDATE public.processed_emails SET org_id = new_org_id WHERE user_id = user_record.id;
    UPDATE public.api_usage_logs SET org_id = new_org_id WHERE user_id = user_record.id;
    UPDATE public.user_settings SET org_id = new_org_id WHERE user_id = user_record.id;
  END LOOP;
END $$;
