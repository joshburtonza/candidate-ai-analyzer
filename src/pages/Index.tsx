...
const Index = () => {
  ...
  const benefits = ["Precision-engineered candidate analysis", "AI-driven assessment intelligence", "Enterprise-grade security architecture", "Real-time processing excellence", "Advanced filtering capabilities", "Refined user experience design"];
  return <div className="min-h-screen elegant-gradient relative overflow-hidden">
        ...
        <header className="container mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold text-white text-elegant tracking-wider">APPLICHUB</span>
            </div>
            <Button onClick={() => navigate('/auth')} variant="outline" className="border-orange-500/30 text-orange-500 hover:bg-orange-500/10 elegant-border px-6 py-2 text-elegant">
              ENTER
            </Button>
          </div>
        </header>
        ...
        <section className="container mx-auto px-6 py-24 text-center">
          ...
          duration: 1
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button onClick={() => navigate('/auth')} className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-10 py-4 text-lg font-semibold text-elegant tracking-wider shadow-xl">
                BEGIN ASSESSMENT
                <ArrowRight className="w-5 h-5 ml-3" />
              </Button>
              <Button variant="outline" className="border-white/20 text-white hover:bg-white/5 px-10 py-4 text-lg elegant-border text-elegant tracking-wider">
                EXPLORE FEATURES
              </Button>
            </div>
          </motion.div>
            ...
            delay: 0.2
              ...
              <Card className="glass-card p-10 elegant-border">
                <div className="text-center">
                  ...
                  <Button onClick={() => navigate('/auth')} className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-8 py-3 font-semibold text-elegant tracking-wider">
                    COMMENCE JOURNEY
                    <ArrowRight className="w-5 h-5 ml-3" />
                  </Button>
                </div>
