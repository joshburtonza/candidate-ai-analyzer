...
export const DashboardHeader = ({
  ...
  return (
    <header className="glass-card border-b border-white/10 sticky top-0 z-50 elegant-border">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-white text-elegant tracking-wider">RESUME INTELLIGENCE</h1>
            </div>
            {profile?.is_admin && (
              <span className="px-3 py-1 bg-gradient-to-r from-yellow-400 to-yellow-600 text-black text-xs rounded-full font-semibold text-elegant tracking-wider">
                ADMIN
              </span>
            )}
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <Input
                ...
                className="w-64 pl-10 glass-card border-white/20 text-white placeholder:text-white/60 focus:border-yellow-400/50 focus:ring-yellow-400/20"
              />
            </div>
            ...
            <div className="flex glass-card rounded-lg p-1 border-white/20">
              <Button
                ...
                className={`text-white ${viewMode === 'grid' ? 'bg-gradient-to-r from-yellow-400 to-yellow-600 text-black' : 'hover:bg-white/10'}`}
              >
              ...
              <Button
                ...
                className={`text-white ${viewMode === 'list' ? 'bg-gradient-to-r from-yellow-400 to-yellow-600 text-black' : 'hover:bg-white/10'}`}
              >
