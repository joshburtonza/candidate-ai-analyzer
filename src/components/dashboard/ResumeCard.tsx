...
export const ResumeCard = ({ upload, onDelete }: ResumeCardProps) => {
  ...
  const data = {
    ...
    justification: upload.justification,
  ...
  const handleDelete = async (e: React.MouseEvent) => {
    ...
    console.log('ResumeCard: Delete button clicked for candidate:', upload.id, data.candidate_name);
    
    const success = await deleteCandidate(upload.id, data.candidate_name || 'Unknown');
    
    console.log('ResumeCard: Delete operation result:', success);
    
    if (success && onDelete) {
      console.log('ResumeCard: Calling onDelete callback');
      onDelete(upload.id);
    } else if (!success) {
      console.error('ResumeCard: Delete operation failed');
    } else if (!onDelete) {
      console.warn('ResumeCard: No onDelete callback provided');
    }
  };
